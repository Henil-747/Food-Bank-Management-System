...
BEGIN
	update employee set SALARY=SALARY+(0.1*SALARY) where TIMESTAMPDIFF(YEAR, JOINING_DATE, CURDATE())>16;
	select * from employee where TIMESTAMPDIFF(YEAR, JOINING_DATE, CURDATE())>16;
END;
//
DELIMITER ;
